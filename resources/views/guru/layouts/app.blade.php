        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('guru.dashboard') }}" class="nav-item nav-link {{ request()-> RouteIs('guru.dashboard') ? 'active' : '' }}"><i class="fa fa-tachometer-alt mn-2"></i> Dashboard</a>
                    <a href="{{ route('guru.pembimbing') }}" class="nav-item nav-link {{ request()-> RouteIs('guru.pembimbing*') ? 'active' : '' }}"><i class="fa fa-table mn-2"></i> Pembimbing</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
